...
describe('retrievePeriod', () => {
  describe('without baseDate', () => {
    describe('when current date is Mon, 20 Mar 2017', () => {
      ...
      test('should retrieve last_3_weeks', () => {
      ...
      test('should retrieve last_3_months period', () => {
      ...
      test('should retrieve last_2_quarters period', () => {
      ...
      test('should retrieve last_2_years period', () => {
      ...
      test('should retrieve last_3_days_including_current period (deprecated in favor of last_3_days)', () => {
        const period = retrievePeriod('last_3_days_including_current');
        expect(period.start).toEqual('2017-03-17');
        expect(period.end).toEqual('2017-03-19');
      });

      test('should retrieve last_2_weeks_including_current period', () => {
        const period = retrievePeriod('last_2_weeks_including_current');
        expect(period.start).toEqual('2017-03-06');
        expect(period.end).toEqual('2017-03-19');
      });

      test('should retrieve last_1_quarter_including_current period', () => {
        const period = retrievePeriod('last_1_quarter_including_current');
        expect(period.start).toEqual('2017-01-01');
        expect(period.end).toEqual('2017-03-19');
      });

      test('should retrieve last_1_year_including_current period', () => {
      ...
      test('should 2014-01-01_to_yesterday period', () => {
    ...
    describe('with utc baseDate to Thu, 01 Jan 2015, 00:00:00', () => {
      ...
      test('should today period be interpreted as yesterday (as today is deprecated)', () => {
      ...
      test('should retrieve this_week period', () => {
      ...
      test('should this_month period be last_month as today is first day of the month', () => {
      ...
      test('should this_quarter period be last_quarter as today is first day of quarter', () => {
      ...
      test('should this_year period be last_year as today is first day of year', () => {
      ...
      test('should year_to_date period be last_year (deprecated and interpreted as this_year)', () => {
        const period = retrievePeriod('year_to_date', january2015);
        expect(period.start).toEqual('2014-01-01');
        expect(period.end).toEqual('2014-12-31');
      });

      test('should unknown period throw an Error', () => {
      ...
      test('should retrieve 2014-01-01_to_yesterday period', () => {
