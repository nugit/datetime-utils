...
var parseISO = function parseISO(date, options) {
  return typeof date === 'string' ? _parseISO__default['default'](date, options) : date;
...
var max = function max(dates) {
  return _max__default['default'](dates.map(parseISO));
}; // :: Array(Date | Int | String) -> Date

var min = function min(dates) {
  return _min__default['default'](dates.map(parseISO));
}; // :: (Date | Int | String) -> Number -> Date
