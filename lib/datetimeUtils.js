...
function calculateAutoCompare(periodOrKey, baseDate) {
  ...
  if (params && params.type === 'this') {
    ...
    var span = moment.duration(moment(period.end).diff(period.start)).asDays() + 1;
    autoCompareInfo.period = {
...
module.exports = { getDateRange: getDateRange, retrievePeriod: retrievePeriod, retrievePeriodParams: retrievePeriodParams, calculateAutoCompare: calculateAutoCompare };